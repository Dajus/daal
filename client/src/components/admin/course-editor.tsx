      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            Pokud není zadáno, použijí se všechny aktivní otázky. Jinak se náhodně vybere zadaný počet otázek z celkového počtu.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              Pokud nevyplníte, použijí se všechny otázky
            </p>
          </div>
        </div>
                  ...
                  >
                    <div>
                      ...
                      <div className="text-sm opacity-75 mt-1">
                        {selectedCourseId === course.id ? `${selectedCourseCounts.slides} snímků • ${selectedCourseCounts.questions} otázek` : 'Vyberte pro zobrazení obsahu'}
                      </div>
                    </div>
                  </Button>
              ...
              <>
                <div className="flex justify-between items-center mb-6">
                  <div>
                    ...
                    <Badge variant="secondary" className="mt-1 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200">
...
const QuestionFormDialog = ({ question, onSave, isLoading }: {
  ...
  return (
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
        <DialogHeader>
          <DialogTitle className="text-gray-900 dark:text-white">{question ? 'Upravit otázku' : 'Přidat otázku'}</DialogTitle>
        </DialogHeader>
        <div className="space-y-4">
          <div>
...
const SortableSlideItem = ({ slide, index, onEdit, onDelete }: {
  slide: TheorySlide;
  index: number;
  onEdit: () => void;
  onDelete: () => void;
        ...
        <CardContent className="p-4">
          <div className="flex justify-between items-start">
            ...
            <div className="flex space-x-2 ml-4">
              <Button variant="ghost" size="sm" onClick={onEdit} className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                <Edit className="h-4 w-4" />
              </Button>
              <Button variant="ghost" size="sm" onClick={onDelete} className="text-gray-600 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400">
                <Trash2 className="h-4 w-4" />
              </Button>
            </div>
          </div>
...
const SortableQuestionItem = ({ question, index, onEdit, onDelete }: {
        ...
        <CardContent className="p-4">
          <div className="flex justify-between items-start mb-3">
            <div className="flex items-center gap-3">
              ...
              Otázka {index + 1} • {question.questionType === 'single_choice' ? 'jedna správná' : 'více správných'} • {question.points} bodů
            </span>
            </div>
                  ...
                  return (
                      <div key={optionIndex} className="flex items-center">
                        <input
                            ...
                            disabled
                        />
                        <label className={`text-sm ${isCorrect ? 'font-medium text-gray-900 dark:text-white' : 'text-gray-700 dark:text-gray-300'}`}>
                          {option}
                        </label>
                      </div>
                  );
