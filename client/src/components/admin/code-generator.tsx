              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setFormData((prev) => ({ ...prev, unlimitedParticipants: checked }))}
                  />
                </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setFormData((prev) => ({ ...prev, theoryToTest: checked }))}
                  />
                </div>
              </div>
                      ...
                      <div className="space-y-2">
                        {group.codes.map((code: any) => {
                          ...
                          return (
                            <div
                              key={code.id}
                              className="bg-white dark:bg-gray-800 p-3 rounded-lg border border-emerald-200 dark:border-emerald-700 shadow-sm"
                            >
                              <div className="flex justify-between items-start mb-2">
                                <Badge
                                  variant="secondary"
                                  className="bg-emerald-100 text-emerald-800 font-mono text-sm"
                                >
                                  {code.code}
                                </Badge>
                                <Button
                              ...
                              <div className="space-y-1 text-xs">
                                <p className="text-gray-700 dark:text-gray-300">
                                  <span className="font-medium">Kurz:</span> {course?.name || 'N/A'}
                                </p>
                                <p className="text-gray-700 dark:text-gray-300">
                                  <span className="font-medium">Společnost:</span> {company?.name || 'N/A'}
                                </p>
                                <div className="flex items-center justify-between">
