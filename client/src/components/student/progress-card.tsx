      ...
      <Card className="shadow-lg bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
        <CardContent className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Sekce teorie */}
            <Card className={`${progress.theoryCompleted ? 'bg-emerald-50 dark:bg-emerald-900/20 border-emerald-200 dark:border-emerald-700' : 'bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600'}`}>
            ...
            {/* Sekce testu */}
            <Card className={`${
                progress.passed ? 'bg-emerald-50 dark:bg-emerald-900/20 border-emerald-200 dark:border-emerald-700' :
                    progress.testCompleted ? 'bg-yellow-50 dark:bg-yellow-900/20 border-yellow-200 dark:border-yellow-700' :
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  >
                    {progress.passed ? "Splněno" :
                        progress.testCompleted ? `${progress.attempts.length}/${progress.course.maxAttempts} pokusů` :
                            "Nezahájeno"}
                  </Badge>
                </div>
