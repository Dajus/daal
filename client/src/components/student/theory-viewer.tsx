    ...
    <div className="space-y-6">
        ...
        <CardContent className="p-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Celkem {slides.length} témat k prostudování
            </p>
          </div>
        </CardContent>
      </Card>
          ...
          <Card className="shadow-lg bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            <CardContent className="p-4 sm:p-6">
              ...
              <div className="min-h-[250px] sm:min-h-[300px] lg:min-h-[400px] mb-6 flex flex-col">
                ...
                {/* Media content */}
                {slides[currentSlideIndex]?.mediaUrls && Array.isArray(slides[currentSlideIndex]?.mediaUrls) && slides[currentSlideIndex]?.mediaUrls.length > 0 && (
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 mb-6">
                ...
                >
                  <Bookmark className={`h-4 w-4 mr-2 ${bookmarkedSlides.has(slides[currentSlideIndex]?.id) ? 'fill-current' : ''}`} />
                ...
                >
                  <StickyNote className={`h-4 w-4 mr-2 ${slideNotes[slides[currentSlideIndex]?.id] ? 'fill-current' : ''}`} />
      ...
      {isTransitioning && (
        <div className="fixed inset-0 bg-white dark:bg-gray-900 z-50 flex items-center justify-center">
          <LoadingScreen 
            title="Příprava testu..." 
            description="Načítání otázek a testovacího prostředí"
            size="xl"
          />
        </div>
      )}
